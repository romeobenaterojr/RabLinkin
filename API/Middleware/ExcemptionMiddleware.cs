...
public class ExcemptionMiddleware(ILogger<ExcemptionMiddleware> logger, IHostEnvironment env) : IMiddleware
{
    ...
    private static async Task HandleValidationException(HttpContext context, FluentValidation.ValidationException ex)
    {
        ...
        var validationProblemDetails = new ValidationProblemDetails(validationErrors)
        {
            ...
            Detail = "One or more validation errror has occurred"
        };
